    ...
    <Col xs={3} xsOffset={2} className={`${releaseAndFactStyles.contentBorder} ${releaseAndFactStyles.release}`}>
      ...
      <img src={ ReleaseImg } />
        ...
        <p>
          ...
          <br /><br />We recently converted our <a target="_blank" href="https://docs.electrode.io/"> open source documentation </a> to the gitbook format and hosted on their servers.
      ...
      <p>
        <a target="_blank" href="https://github.com/electrode-io/electrode/tree/master/packages/electrode-archetype-react-component">Electrode Component Archetype</a> helps developers to quickly build React components.
          ...
          <br />If you want to try out the latest electrode component, please generate them by the latest <a target="_blank" href="https://github.com/electrode-io/electrode/tree/master/packages/generator-electrode"> electrode-generator.</a>
      </p>
      ...
      <p>
        ...
        Check out the latest generator <a target="_blank" href="https://github.com/electrode-io/electrode/tree/master/packages/generator-electrode"> here.</a>.
      </p>
